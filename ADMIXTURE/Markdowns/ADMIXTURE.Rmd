...
To visualize the results locally, we first need to establish a connection with or local computer. On the terminal on local machine (i.e. not logged into UPPMAX), input the following:
