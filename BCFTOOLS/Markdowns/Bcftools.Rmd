...
```
Only including sites covered in at least two samples (alternative to Fmiss):
```{bash, eval = FALSE}
...
* -S, --samples-file: File of sample names to include or exclude if prefixed with "^". One sample per line.
